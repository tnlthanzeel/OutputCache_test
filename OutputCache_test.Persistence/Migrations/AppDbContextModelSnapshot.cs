...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OutputCache_test.Core.Security.Entities.ApplicationUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("OutputCache_test.Core.Security.Entities.Role", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("OutputCache_test.Core.Security.Entities.SP_CheckUserClaim", b =>
                {
            ...
            modelBuilder.Entity("OutputCache_test.Core.Security.Entities.UserClaim", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OutputCache_test.Core.Security.Entities.UserProfile", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("OutputCache_test.Core.Security.Entities.UserClaim", b =>
                {
                    b.HasOne("OutputCache_test.Core.Security.Entities.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("OutputCache_test.Core.Security.Entities.UserProfile", b =>
                {
                    b.HasOne("OutputCache_test.Core.Security.Entities.ApplicationUser", "ApplicationUser")
                        .WithOne("UserProfile")
                        .HasForeignKey("OutputCache_test.Core.Security.Entities.UserProfile", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<System.Guid>", b =>
                {
                    b.HasOne("OutputCache_test.Core.Security.Entities.Role", null)
                        .WithMany()
